...
class DashboardController extends AbstractDashboardController
{
    public function index(): Response
    {
        ...
        return $this->redirect($adminUrlGenerator->setController(AlerteCrudController::class)->generateUrl());
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Alertes', 'fas fa-list', Alerte::class);
        yield MenuItem::linkToCrud('Aquariums', 'fas fa-list', Aquarium::class);
